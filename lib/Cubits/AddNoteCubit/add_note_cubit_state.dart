...
final class AddNoteCubitLoadding extends AddNoteCubitState {}

final class AddNoteCubitSuccess extends AddNoteCubitState {}

final class AddNoteCubitFailuer extends AddNoteCubitState {
  final String errMessage;

  AddNoteCubitFailuer({required this.errMessage});
}
